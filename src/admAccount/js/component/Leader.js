        ...
        this.state = {
            ...
            columns: [
                    ...
                    render: arr => {
                        return (
                            <div className='name-content'>
                                <span title={arr.Name} className='name-UserName' onClick={this.onUserNameClick.bind(this, arr.UserID)}>{arr.Name ? arr.Name : '--'}</span><br />
                                <span title={arr.UserID} className='name-UserID'>( <span className='overflow-text'>{arr.UserID ? arr.UserID : '--'}</span> )</span>
                            </div>
                        )
                    }
                ...
                },
                {
                    ...
                    render: ShortName => {
                        return (
                            <span title={ShortName} className='UserName ShortName'>{ShortName ? ShortName : '--'}</span>
                        )
                    }
                },
                {
    ...
    onPwdchangeOk = (pwd) => {
        ...
        if (this.state.defaultPwd === '') {
            ...
            postData(CONFIG.UserAccountProxy + url,
                {
                    userID: DataState.SchoolLeaderPreview.newList[this.state.onClickKey].Others.UserID,
                    userType: 7,
                ...
                2).then(res => {
                    ...
                    if (json.StatusCode === 400) {
                        ...
                        dispatch(actions.UpDataState.getSchoolLeaderPreview('/GetSchoolLeader?SchoolID=' + this.state.userMsg.SchoolID + this.state.sortFiled + this.state.sortType));
        ...
        return (
            <div className='Leader'>
                    ...
                    <div className='Leader-content'>
                        ...
                        <div className='content-render'>
                            <div>
                                ...
                                {DataState.SchoolLeaderPreview.Total?(<CheckBox className='checkAll-box' onChange={this.OnCheckAllChange} checked={this.state.checkAll}>
                                    全选
                ...
                <Alert show={this.state.ChangePwdMadalVisible}
                    ...
                    title={this.state.ChangePwdMadalVisible ? <p className='alert-Title'>确定重置<span className='alert-Title-name'>{DataState.SchoolLeaderPreview.newList[this.state.onClickKey].UserName.Name}</span><span className='alert-Title-id'>({DataState.SchoolLeaderPreview.newList[this.state.onClickKey].UserName.UserID})</span> 的密码？</p> : ''}
