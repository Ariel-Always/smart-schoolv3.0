...
class Teacher extends Component{
    ...
    CloseChangeTime(){
        ...
        dispatch({type:STTActions.TEACHER_STT_CHANGE_TIME_MODAL_HIDE});
    ...
    ChangeClassRoomPick(e){
        ...
        dispatch({type:STTActions.TEACHER_STT_ADJUST_CLASSROOM_MODAL_CHECKED_CHANGE,data:e.target.value});
    ...
    ChangeClassRoomType(key){
        ...
        dispatch({type:STTActions.TEACHER_STT_ADJUST_CLASSROOM_MODAL_CLASSROOM_TYPE_CHANGE,data:key});
    ...
    SearchValueChange(e){
        ...
        dispatch({type:STTActions.TEACHER_STT_ADJUST_CLASSROOM_MODAL_SEARCH_VALUE_CHANGE,data:e.target.value});
    ...
    ClassRoomSearchCancel(){
        ...
        dispatch({type:STTActions.TEACHER_STT_ADJUST_CLASSROOM_MODAL_SEARCH_CANCEL_BTN_HIDE});

        dispatch({type:STTActions.TEACHER_STT_ADJUST_CLASSROOM_MODAL_SEARCH_WRAPPER_HIDE});

        dispatch({type:STTActions.TEACHER_STT_ADJUST_CLASSROOM_MODAL_SEARCH_VALUE_CHANGE,data:''});
    ...
    CloseAdjustClassRoom(){
        ...
        dispatch({type:STTActions.TEACHER_STT_ADJUST_CLASSROOM_MODAL_HIDE});
    ...
    ReplaceTeacherPick(ID){
        ...
        dispatch({type:STTActions.TEACHER_STT_REPLACE_SCHEDULE_MODAL_TEACHER_PICK,data:ID});
    ...
    ReplaceSearchValueChange(e){
        ...
        dispatch({type:STTActions.TEACHER_STT_REPLACE_SCHEDULE_MODAL_INPUT_CHANGE,data:e.target.value});
    ...
    ReplaceSearchCancel(){
        ...
        dispatch({type:STTActions.TEACHER_STT_REPLACE_SCHEDULE_MODAL_SEARCH_CANCEL_BTN_HIDE});

        dispatch({type:STTActions.TEACHER_STT_REPLACE_SCHEDULE_MODAL_SEARCH_WRAPPER_HIDE});

        dispatch({type:STTActions.TEACHER_STT_REPLACE_SCHEDULE_MODAL_INPUT_CHANGE,data:''});
    ...
    ReplaceScheduleClose(){
        ...
        dispatch({type:STTActions.TEACHER_STT_REPLACE_SCHEDULE_MODAL_HIDE});
