...
class All extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (Object.keys(userData.NewGrades).length > 0 && Object.keys(userData.NewSubjects).length > 0 && this.state.refresh) {
            this.setState({
                refresh: false
            })
                ...
                <div className='All-box All-user'>
                    ...
                    <div className='All-content user-content'>
                        ...
                        <div className='echarts-tips'>
                            ...
                            <p className='tips-2'><span className='tips-icon-3'></span>{'领导人数：' + DataState.AllUserPreview.SchoolLeader}</p>
                        </div>
                    </div>
                </div>
