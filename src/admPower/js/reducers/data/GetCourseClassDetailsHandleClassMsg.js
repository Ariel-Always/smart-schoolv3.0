...
const GetCourseClassDetailsHandleClassMsg = (state = {}, actions) => {
    switch (actions.type) {
        ...
        case UpDataState.SET_CLASS_STUDENT_TRANSFER_MSG:
            let transferStudent = Object.assign({}, state.transfer, { Student: actions.data });
...
function handleData(data) {
    ...
    return { ...data, TableSource: TableSource, transfer: { Teacher: {}, Student: Student }, selectData: { CourseClass: { CourseClassName: data.CourseClassName, CourseClassID: data.CourseClassID }, Teacher: { value: data.TeacherID, title: data.TeacherName }, Student: Student } };
}
