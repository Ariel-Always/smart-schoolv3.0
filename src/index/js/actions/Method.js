...
//获取数据以及封装数据格式
const getGetData =  async (url,level,api = 'http://192.168.2.202:7300/mock/5d7726e0ed0ccd1564c8df05/webCloudDev') =>{
...
//调用post接口
const getPostData = async (url,data,level,api = 'http://192.168.2.202:7300/mock/5d7726e0ed0ccd1564c8df05/webCloudDev') =>{
