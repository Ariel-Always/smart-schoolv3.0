...
import {
    ...
    CheckBoxGroup, RadioGroup, Table, PagiNation, Search, DropDown, Menu,Loading,Alert
} from '../../../common'
...
class App extends React.Component {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: (item) => {
                          ...
                          return item.map((i,k)=>{
                              if(i==="编辑"){
                                  return  <Button type="primary" key={k} size="small" color="blue" value={i} style={{display:"inline-block",margin:"0 10px 0 0" }}/>
                              }else{
                                  return  <Button type="primary" key={k} size="small" color="red" value={i} style={{display:"inline-block",margin:0}}/>
                              }
                           });
                        }
                    }
    ...
    changeCheckBox(checkedList) {
        this.setState({
            checkedList,
            checkAll: checkedList.length === this.state.plainOptions.length ? true : false
        });
    }
    ;
    ...
    dropClickSearch(e) {
        if (e.value) {
            this.setState({
                dropIdShow: true, dropSearchList: [
                    {
                        id: 145687254,
                        name: "张三"
                    },
     ...
     return (
         <div className="App">
             ...
             <div className="Box ButtonBox">
                    ...
                    <div className="Box-content">
                        <div className="Box-flex">
                            ...
                            <div className="Box-content-show">
                                ...
                                <Empty className="Empty" imageStyle={{ width: 100 + 'px', height: 100 + 'px' }}
                                    type="3" />
                ...
                <div className="Box InputBox">
                    ...
                    <div className="Box-content">
                        <div className="Box-flex">
                            ...
                            <div className="Box-content-show">
                                <Table dataSource={this.state.simpleTable.dataSource}
                                    columns={this.state.simpleTable.columns}
                                    pagination={false}>
                                </Table>
                            </div>
                        </div>
                    ...
                    <div className="Box-content">
                        <div className="Box-flex">
                            ...
                            <div className="Box-content-show">
                                <Table dataSource={this.state.sortTable.dataSource}
                                    columns={this.state.sortTable.columns}
                                    pagination={false}>
                                </Table>
                            </div>
                        </div>
                    ...
                    <div className="Box-content">
                        <div className="Box-flex">
                            ...
                            <div className="Box-content-show">
                                <Table dataSource={this.state.checkTable.dataSource}
                                    columns={this.state.checkTable.columns}
                                    pagination={false}>
                                </Table>
                            </div>
                        </div>
                ...
                <div className="Box InputBox">
                    ...
                    <div className="Box-content">
                        <div className="Box-flex">
                            ...
                            <div className="Box-content-show">
                                <PagiNation defaultCurrent={1} size="small"
                                    onChange={this.changeSmallPage.bind(this)}
                                    total={200}></PagiNation>
                        ...
                        <div className="Box-flex">
                            ...
                            <div className="Box-content-show">
                                <Search placeHolder="输入关键词快速搜索"
                                    onClickSearch={this.simpleClickSearch.bind(this)}></Search>
                        ...
                        <div className="Box-flex">
                            ...
                            <div className="Box-content-show">
                                ...
                                <div style={{ marginLeft: 30 }}>
                                    搜索的类型为：{this.state.selectSearch.selectValue},搜索的关键词为：{this.state.selectSearch.value}</div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="Box InputBox">
                    <div className="BoxTop">
                        <p className="BoxTop_title">左侧菜单组件</p>
                    </div>

                    <div className="Box-content">
                        <div className="Box-flex">
                            <div className="Box-tips">
                                <p className="tips">左侧菜单组件-1：</p>
                            </div>
                            <div className="Box-content-show">
                                <Menu params={this.state.MenuParams}>
