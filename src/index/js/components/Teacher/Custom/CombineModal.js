...
class CombineModal extends React.Component {
  ...
  onEditClick = source => {
    ...
    let CombineData = Teacher.TeacherCustomData.CombineModalData.data;
  ...
  onDeleteClick = (source, data) => {
    ...
    let Row = Teacher.TeacherCustomData.CombineModalData.Row;
    let Key = Teacher.TeacherCustomData.CombineModalData.key;
  ...
  onResetClick = source => {
    ...
    //   )
    // );
    let AllData = Teacher.TeacherCustomData.AllData;
