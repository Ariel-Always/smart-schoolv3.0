...
class Record extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        let dataSource = DataState.GetCourseClassRecordMsg.tableSource ? DataState.GetCourseClassRecordMsg.tableSource : []
            ...
            <div id='Record'>
                <div className='log-box'>
                    <div className='log-top'>
                        ...
                        <Router>
                            <Link to='/Log/Dynamic' className='top-to'>查看最新动态>></Link>
                        </Router>
